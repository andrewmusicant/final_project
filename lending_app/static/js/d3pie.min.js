        ...
        i = {
            ...
            checkConflict: function(a, b, c, d) {
                ...
                if (!(1 >= d)) {
                    ...
                    if (!("clockwise" === c && "right" !== h || "anticlockwise" === c && "left" !== h)) {
                        ...
                        if ("clockwise" === c) {
                            for (e = 0; b >= e; e++)
                                if (g = a.outerLabelGroupData[e], !i.isLabelHidden(a, e) && f.rectIntersect(g, l)) {
            ...
            isLabelHidden: function(a, b) {
                var c = a.options.labels.outer.hideWhenLessThanPercentage,
                    d = j.getPercentage(a, b, a.options.labels.percentage.decimalPlaces);
                return null !== c && c > d || "" === a.options.data.content[b].label
            },
